        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="{{ route('contact.save') }}" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <button type="submit" class="btn btn-primary btn-lg btn-block text-uppercase">Send Message</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              ...
              <span class="d-block text-primary h6 text-uppercase">Addresses</span>
